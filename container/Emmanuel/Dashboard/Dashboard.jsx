  ...
  return (
      <div className={classNames(classes.grid)}>
        <div className={classNames(classes.headingWrapper)}>
          <Typography className={classNames(classes.heading, classes.greeting)} >{dateTime.wish},</Typography>
          <Typography className={classNames(classes.heading, classes.name)}>Emmanuel</Typography>
        </div>
        <div className={classNames(classes.timeWrapper)}>
        <Typography className={classNames(classes.time)}>{dateTime.time}</Typography>
        </div>
      </div>
  )
}
